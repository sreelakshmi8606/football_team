...
class ActivityEditor extends StatefulWidget {
  ...
  late List<AttributeDataModel> Attribute;
  late String Description;
  late int Duration;

  @override
  _ActivityEditorState createState() => _ActivityEditorState();
}
...
class _ActivityEditorState extends State<ActivityEditor> {
  ...
  ActivityDataModel activity = ActivityDataModel.empty();
  @override
                              ...
                              children: <Widget>[
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    onSaved: (String? value) {
                                      activity.Duration = value! as int;
                                    },
                                    controller: ActivityNameController,
                                    keyboardType: TextInputType.text,
                                    decoration: InputDecoration(
